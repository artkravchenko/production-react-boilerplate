...
"$PACKAGE/scripts/build/webpack/before-build.sh"

webpack_path="$PACKAGE/node_modules/.bin/webpack"
webpack_config_path="$PACKAGE/resources/build/webpack/app.config.js"

node "$webpack_path" --config "$webpack_config_path" "$@"
